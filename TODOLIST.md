...
- [ ] 能画出「model_type 字符串 -> 配置类」的完整调用链（注意 from_pretrained 的首参是仓库 id/路径，按 model_type 取类要用 for_model）
- [ ] 能解释惰性映射省下了什么
...
| 19 | `L2-07` | 视觉塔：从 336x336 像素到 144 个 token | P0 | 3 | ✅ |
...
<details><summary><b>L2-07</b> 视觉塔：从 336x336 像素到 144 个 token <code>L2-input/L2-07</code></summary>
