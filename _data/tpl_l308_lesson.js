...
/* ============================================================ 2 顺序① */
{
  ...
  build(root, tl) {
    ...
    const lane = U.el('div', { class: 'row gap14', style: 'width:100%;align-items:flex-start' });
    ...
    /* 中：mHC */
    const mid = U.el('div', { class: 'col gap6', style: 'flex:none;width:250px' });
    mid.appendChild(U.el('div', { class: 'klabel', text: '① 一次调用给出三样' }));
    ...
    right.appendChild(U.el('div', { class: 'klabel', text: '② 只有收拢后的那一条往下走' }));
