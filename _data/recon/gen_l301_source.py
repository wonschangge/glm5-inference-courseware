#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""L3-01 source.md 生成器：代码一律从源文件按行切片，绝不手抄。"""
import io
import os
import sys
...
path = "/data/WORKSPACE/transformer-project/courseware/L3-backbone/L3-01/source.md"
with open(path, "w", encoding="utf-8") as f:
    f.write(out.getvalue())
print("wrote", path, len(out.getvalue().split("\n")), "lines")
