"""把 L3-06 的 source.md 装配出来：散文手写，代码块**从源文件切片**（绝不重打）。

用法：./.venv/bin/python courseware/_data/recon/gen_l306_source.py
"""
import os

HERE = os.path.dirname(os.path.abspath(__file__))
SRC = os.path.abspath(os.path.join(HERE, "..", "..", "..", "upstream-transformers",
                                   "src", "transformers", "models", "glm5_next",
                                   "modeling_glm5_next.py"))
OUT = os.path.abspath(os.path.join(HERE, "..", "..", "L3-backbone", "L3-06", "source.md"))
...
P = "models/glm5_next/modeling_glm5_next.py"
...
T = (T.replace("@@P@@", P)
      .replace("@@B_1314_1317@@", B(1314, 1317))
      .replace("@@B_298_307@@", B(298, 307))
      .replace("@@B_211_217@@", B(211, 217))
      .replace("@@B_273_285@@", B(273, 285))
      .replace("@@B_308_317@@", B(308, 317))
      .replace("@@B_319_326@@", B(319, 326))
      .replace("@@B_323_326@@", B(323, 326))
      .replace("@@B_328_331@@", B(328, 331))
      .replace("@@B_1337_1339@@", B(1337, 1339))
      .replace("@@B_1298_1299@@", B(1298, 1299))
      .replace("@@B_334_338@@", B(334, 338)))

assert "@@" not in T, "还有未替换的占位符"
os.makedirs(os.path.dirname(OUT), exist_ok=True)
with open(OUT, "w", encoding="utf-8") as f:
    f.write(T)
print("wrote", OUT, len(T.split("\n")), "lines")
print("引用块数 =", T.count("<!-- src:"))
